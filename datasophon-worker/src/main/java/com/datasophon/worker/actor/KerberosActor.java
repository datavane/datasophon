...
public class KerberosActor extends UntypedActor {
    ...
    public void onReceive(Object message) throws Throwable {
        if (message instanceof GenerateKeytabFileCommand) {
            ...
            String keytabFilePath = "/etc/security/keytab/" + command.getKeytabName();
            ...
            if (!FileUtil.exist(keytabFilePath)) {
                ...
                String keytabCmd = "kadmin -padmin/admin -wadmin -q \"xst -k /etc/security/keytab/" + command.getKeytabName() + " " + command.getPrincipal() + "\"";
