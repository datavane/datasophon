...
baseurl=file:///data/private-yum-library/repo/centos/8/x86_64/BaseOS/
gpgcheck=0
enable=1

[dataSophon-AppStream]
name=dataSophon-AppStream
baseurl=file:///data/private-yum-library/repo/centos/8/x86_64/AppStream/
gpgcheck=0
enabled=1
...
yum clean all
yum makecache
echo "init-private-yum-library-centos8.sh finished."
echo "Done."
...
#unlink /var/www/html/epel
#ln -s /data/datasophon-init/private-yum-library/epel/ /var/www/html/
