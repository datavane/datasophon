...
/** @Title: prometheus工具类 @Description: */
public class PromInfoUtils {
    ...
    public static List<PromResultInfo> getPrometheusMetrics(String promURL, String promQL) {
        ...
        if (StringUtils.isBlank(status) || !Constants.SUCCESS.equals(status)) {
            return null;
        }
    ...
    public static void main(String[] args) {
        //  List<PromResultInfo> windowsOsInfo =
        // getWindowsInfo("http://10.0.50.225:9090/api/v1/query", PromConstants.WINDOWS_OS_INFO);

        List<PromResultInfo> hadoop_nameNode_threads =
                getPrometheusMetrics(
                        "http://172.31.96.16:9090/api/v1/query",
