...
public class ServiceInstallController {
    @Autowired ServiceInstallService serviceInstallService;
    ...
    public Result saveServiceConfig(
            Integer clusterId, String serviceName, String serviceConfig, Integer roleGroupId) {
    ...
    public Result saveServiceRoleHostMapping(
    ...
    public Result saveHostServiceRoleMapping(
            @PathVariable("clusterId") Integer clusterId,
    ...
    public Result startInstallService(
            @PathVariable("clusterId") Integer clusterId, @RequestBody List<String> commandIds) {
    ...
    public void downloadPackage(
            String packageName, String cpuArchitecture, HttpServletResponse response)
            throws IOException {
