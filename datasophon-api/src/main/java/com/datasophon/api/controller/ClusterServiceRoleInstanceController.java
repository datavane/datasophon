...
public class ClusterServiceRoleInstanceController {
    @Autowired private ClusterServiceRoleInstanceService clusterServiceRoleInstanceService;
    ...
    public Result list(
            ...
            Integer page,
            Integer pageSize) {
        return clusterServiceRoleInstanceService.listAll(
                serviceInstanceId,
                hostname,
                serviceRoleState,
                serviceRoleName,
    ...
    public Result decommissionNode(String serviceRoleInstanceIds, String serviceName)
            throws Exception {
        return clusterServiceRoleInstanceService.decommissionNode(
                serviceRoleInstanceIds, serviceName);
    }
