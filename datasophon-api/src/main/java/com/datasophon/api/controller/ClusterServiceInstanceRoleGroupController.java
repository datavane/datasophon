...
public class ClusterServiceInstanceRoleGroupController {
    ...
    public Result list(Integer serviceInstanceId) {
        List<ClusterServiceInstanceRoleGroup> list =
                clusterServiceInstanceRoleGroupService.list(
    ...
    public Result info(@PathVariable("id") Integer id) {
        ...
        return Result.success()
                .put("clusterServiceInstanceRoleGroup", clusterServiceInstanceRoleGroup);
    }

    /** 保存 */
    @RequestMapping("/save")
    public Result save(Integer serviceInstanceId, Integer roleGroupId, String roleGroupName) {
        clusterServiceInstanceRoleGroupService.saveRoleGroup(
                serviceInstanceId, roleGroupId, roleGroupName);
        return Result.success();
    }
