...
public class ClusterRoleUserController {
     ...
     * 保存
     */
    @ApiOperation(value = "集群用户保存")
    @PostMapping("/saveClusterManager")
    @UserPermission
