...
public class ClusterServiceRoleInstanceConfigController {
    ...
    public Result info(@PathVariable("id") Integer id) {
        ...
        return Result.success()
                .put("clusterServiceRoleInstanceConfig", clusterServiceRoleInstanceConfig);
    }

    /** 保存 */
    @RequestMapping("/save")
    public Result save(
            @RequestBody ClusterServiceRoleInstanceConfigEntity clusterServiceRoleInstanceConfig) {
