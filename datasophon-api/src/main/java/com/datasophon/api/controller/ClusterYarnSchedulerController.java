...
public class ClusterYarnSchedulerController {
    @Autowired private ClusterYarnSchedulerService clusterYarnSchedulerService;
    ...
    public Result info(Integer clusterId) {
        ClusterYarnScheduler clusterYarnScheduler =
                clusterYarnSchedulerService.getScheduler(clusterId);
