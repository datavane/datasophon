...
public class UserInfoController {
    ...
    public Result all() {
        List<UserInfoEntity> list =
                userInfoService.lambdaQuery().eq(UserInfoEntity::getId, 1).list();
