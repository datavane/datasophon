...
public class StartWorkerHandler implements DispatcherWorkerHandler {
    ...
    public boolean handle(ClientSession session, HostInfo hostInfo) throws UnknownHostException {
        ...
        String updateCommonPropertiesResult =
                MinaUtils.execCmdWithResult(
                        session,
        ...
        if (StringUtils.isBlank(updateCommonPropertiesResult)
                || "failed".equals(updateCommonPropertiesResult)) {
            ...
            MinaUtils.execCmdWithResult(
                    ...
                    "\\cp "
                            + installPath
                            + "/datasophon-worker/script/datasophon-worker /etc/rc.d/init.d/");
            ...
            MinaUtils.execCmdWithResult(
                    ...
                    "\\cp "
                            + installPath
                            + "/datasophon-worker/script/datasophon-env.sh /etc/profile.d/");
            ...
            MinaUtils.execCmdWithResult(
                    session, "service datasophon-worker restart " + Constants.INSTALL_PATH + "");
