...
public class ServiceExecuteResultActor extends UntypedActor {
        ...
        if (message instanceof ServiceExecuteResultMessage) {
            ...
            if (result.getServiceRoleType().equals(ServiceRoleType.MASTER)) {
                if (result.getServiceExecuteState().equals(ServiceExecuteState.ERROR)) {
                    ...
                    logger.info(
                            "{} master roles failed , cancel all next node by commandId {}",
                            node,
    ...
    public void listCancelCommand(
            DAGGraph<String, ServiceNode, String> dag, String node, List<String> commandIds) {
    ...
    private void tellToSubmitActiveTaskNode(
            ServiceExecuteResultMessage result,
