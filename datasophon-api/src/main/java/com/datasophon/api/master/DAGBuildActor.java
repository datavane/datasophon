            ...
            if (Objects.nonNull(list) && list.size() > 0) {
                for (ClusterServiceCommandEntity command : list) {
                    ...
                    for (ClusterServiceCommandHostCommandEntity hostCommand : hostCommandList) {
                        ...
                        if("HiveServer2".equals(serviceRoleInfo.getName()) && CacheUtils.getBoolean("enableHiveServer2HA") && !hostCommand.getHostname().equals(globalVariables.get("${masterHiveServer2}"))){
