...
public interface ClusterServiceRoleGroupConfigService
        extends IService<ClusterServiceRoleGroupConfig> {

    ClusterServiceRoleGroupConfig getConfigByRoleGroupId(Integer roleGroupId);

    ClusterServiceRoleGroupConfig getConfigByRoleGroupIdAndVersion(
            Integer roleGroupId, Integer version);

    void removeAllByRoleGroupId(Integer roleGroupId);

    List<ClusterServiceRoleGroupConfig> listRoleGroupConfigsByRoleGroupIds(
