...
public class ClusterAlertHistoryServiceImpl
    ...
    private static final Logger logger =
            LoggerFactory.getLogger(ClusterAlertHistoryServiceImpl.class);
    ...
    @Override
    public ClusterAlertHistory getOneBy(
        ...
        return this.lambdaQuery()
                ...
                .eq(ClusterAlertHistory::getAlertTargetName, alertTargetName)
                .eq(ClusterAlertHistory::getIsEnabled, isEnabled)
                .one();
    }
    ...
    public void saveAlertHistory(String alertMessage) {
        ...
        for (Alerts alertInfo : alerts) {
            ...
            ClusterAlertHistory clusterAlertHistory =
                    this.getOneBy(labels.getClusterId(), hostname, labels.getAlertname(), 1);
    ...
    public Result getAlertList(Integer serviceInstanceId) {
        List<ClusterAlertHistory> list =
                this.lambdaQuery()
                        .eq(
                                serviceInstanceId != null,
                                ClusterAlertHistory::getServiceInstanceId,
                                serviceInstanceId)
                        .eq(ClusterAlertHistory::getIsEnabled, 1)
                        .list();
    ...
    public Result getAllAlertList(Integer clusterId, Integer page, Integer pageSize) {
        ...
        LambdaQueryChainWrapper<ClusterAlertHistory> wrapper =
                this.lambdaQuery()
                        .eq(ClusterAlertHistory::getClusterId, clusterId)
                        .eq(ClusterAlertHistory::getIsEnabled, 1);
        List<ClusterAlertHistory> list = wrapper.last("limit " + offset + "," + pageSize).list();
    ...
    public void removeAlertByRoleInstanceIds(List<Integer> ids) {
        ...
        this.lambdaUpdate()
                .eq(ClusterAlertHistory::getIsEnabled, 1)
                .in(ClusterAlertHistory::getServiceRoleInstanceId, ids)
                .remove();
        // 重新配置prometheus
