...
<template>
  <div class="steps7 steps">
    ...
    <a-button class="btn-save" type="primary" @click="handleSubmit"
      >保存</a-button
    >
    <a-spin :spinning="loading" style="position: relative">
      <a-tabs
        ...
        @change="callback"
        style="max-width: 1330px; position: relative"
      >
        <a-tab-pane
      ...
      <div
        :class="[
          'steps-body',
          serviceNameKey === item ? 'steps-container' : '',
        ]"
        v-for="item in SERVICENAMES"
        :key="item"
      >
        ...
        <CommonTemplate
          ...
          :class="[
            serviceNameKey === item
              ? 'steps-container show-template'
              : 'steps-container hide-template',
            item + 'warp',
          ]"
